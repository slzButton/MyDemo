...
#define HOME_URL [NSString stringWithFormat:@"http://%@:12580/examples/build/hello.js", DEMO_HOST]

#define BUNDLE_URL [NSString stringWithFormat:@"file://%@/bundlejs/hello.js",[NSBundle mainBundle].bundlePath]
