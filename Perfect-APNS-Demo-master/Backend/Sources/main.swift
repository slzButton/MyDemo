...
let notificationsAppId = "cn.cltx.mobile.LinOS"

let apnsKeyIdentifier = "BVMK7VMQM8"
let apnsTeamIdentifier = "PR3484TW5B"
let apnsPrivateKey = "./keys/AuthKey_BVMK7VMQM8.p8"
