...
/// Base interface for reconstructions with SmartTerrainBuilder in the Vuforia system (DEPRECATED).
/**
 * Deprecated: The Smart Terrain API has been deprecated. It will be replaced
 * with a new API in an upcoming Vuforia release.
 */
