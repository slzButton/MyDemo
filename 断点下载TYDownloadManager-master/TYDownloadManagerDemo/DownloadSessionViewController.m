...
static NSString * const downloadUrl3 = @"http://dev.auto-link.com.cn:81/file-service/file/view/5113e807526d4ab9804d43487b93370c";
...
- (void)refreshDowloadInfo
{
    ...
    TYDownloadModel *model = [[TYDownloadModel alloc]initWithURLString:downloadUrl3];
